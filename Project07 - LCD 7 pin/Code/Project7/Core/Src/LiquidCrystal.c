...
void lcd_init(GPIO_TypeDef *gpioport, uint16_t rs, uint16_t rw, uint16_t enable,
			     uint16_t d4, uint16_t d5, uint16_t d6, uint16_t d7)
{
  if(_fourbit_mode)
    init(1, gpioport, rs, rw, enable, d4, d5, d6, d7, 0, 0, 0, 0);
  else
    init(0, gpioport, rs, rw, enable, d4, d5, d6, d7, 0, 0, 0, 0);
}
...
size_t lcd_puts(const char str[]) {
...
inline size_t lcd_putchar(uint8_t value) {
